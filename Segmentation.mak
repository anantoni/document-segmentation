...
VERSION = BCB.06.00
# ---------------------------------------------------------------------------
PROJECT = Segmentation.exe
OBJFILES = Segmentation.obj Main.obj
RESFILES = Segmentation.res
MAINSOURCE = Segmentation.cpp
...
SPARELIBS = vcl.lib rtl.lib dclusr.lib
DEFFILE = 
OTHERFILES = 
# ---------------------------------------------------------------------------
...
INCLUDEPATH = "C:\Program Files\Borland\CBuilder6\Projects";$(BCB)\Imports;C:\Users\ek\Desktop\Segmentation;$(BCB)\include;$(BCB)\include\vcl
LIBPATH = "C:\Program Files\Borland\CBuilder6\Projects";$(BCB)\Imports;C:\Users\ek\Desktop\Segmentation;$(BCB)\Projects\Lib;$(BCB)\lib\obj;$(BCB)\lib
WARNINGS= -w-par
PATHCPP = .;
PATHASM = .;
PATHPAS = .;
...
CFLAG1 = -Od -H=$(BCB)\lib\vcl60.csm -Hc -Vx -Ve -X- -r- -a8 -b- -k -y -v -vi- -c \
    -tW -tWM
IDLCFLAGS = -I"C:\Program Files\Borland\CBuilder6\Projects" -I$(BCB)\Imports \
    -IC:\Users\ek\Desktop\Segmentation -I$(BCB)\include -I$(BCB)\include\vcl \
